# Manual Setup (openstack CLI) — Troubleshooting

Real problems I ran into while working through the manual openstack CLI setup (see [openstack-cli.md](openstack-cli.md)), with causes and fixes. Search this page for your exact error message.
